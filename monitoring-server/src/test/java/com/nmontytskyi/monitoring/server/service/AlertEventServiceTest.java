...
class AlertEventServiceTest {
    ...
    private AlertEventEntity buildEvent(Long id, RegisteredServiceEntity svc, AlertRuleEntity rule) {
    ...
    void findByServiceId_returnsMappedPage() {
        ...
        AlertEventEntity event = buildEvent(100L, svc, rule);
    ...
    void findByServiceId_multipleEvents_allMapped() {
        ...
        AlertEventEntity e1 = buildEvent(301L, svc, rule);
        AlertEventEntity e2 = buildEvent(302L, svc, rule);
